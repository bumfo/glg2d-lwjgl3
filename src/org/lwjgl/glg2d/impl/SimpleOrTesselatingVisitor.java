 ...
 */
package org.lwjgl.glg2d.impl;

import org.lwjgl.glg2d.PathVisitor;
...
public class SimpleOrTesselatingVisitor extends SimplePathVisitor {
  ...
  public void setGLContext(GL context) {
    ...
    if (tesselatorFallback != null) tesselatorFallback.setGLContext(context);
  }
  ...
  public void moveTo(float[] vertex) {
    ...
    if (isConvexSoFar) {
      ...
      if (tesselatorFallback == null) throw new UnsupportedOperationException();
