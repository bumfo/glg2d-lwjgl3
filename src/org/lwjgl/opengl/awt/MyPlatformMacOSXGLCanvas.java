...
public class MyPlatformMacOSXGLCanvas implements PlatformGLCanvas {
  ...
  private static long createView(long platformInfo, long pixelFormat, int x, int y, int width, int height) {
    try {
      Method method = PlatformMacOSXGLCanvas.class.getDeclaredMethod("createView", long.class, long.class, int.class, int.class, int.class, int.class);
      method.setAccessible(true);
      return (long) method.invoke(new PlatformMacOSXGLCanvas(), platformInfo, pixelFormat, x, y, width, height);
